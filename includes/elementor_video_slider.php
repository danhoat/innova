...
class Innova_VideoGallery extends EAE_Widget_Base {

	public function get_name() {
		return 'eae-videogallery';
	}

	public function get_title() {
		return __( 'INNOVA - Video Slider', 'wts-eae' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'slide_thumb_image',
			[
				'label'        => __( 'Custom Video URl', 'wts-eae' ),
